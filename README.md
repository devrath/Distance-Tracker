...
| [**`In-App updates`**](https://developer.android.com/guide/playcore/in-app-updates): Using this API, users will be able to update the application in the background in an eligant way thus keeping the app always up-to-date. | [Documentation](https://developer.android.com/guide/playcore/in-app-updates/kotlin-java) | <img src="https://github.com/devrath/Distance-Tracker/blob/main/Assets/ScreenGif/switch_map_types.gif" width="160" height="330"/> |
